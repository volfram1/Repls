...
in StoreProduct Class create a method to display the output of class variables. (Output sequence as as order of
...
public class Repl0144 {
    ...
    public Repl0144(String label, double price, String category, boolean hasExpiration, int stock) {
        this.label = label;
        this.price = price;
    ...
    public Repl0144(String label, double price, int stock) {
        this.label = label;
        this.price = price;
        this.stock = stock;
        category="misc";
    ...
    public Repl0144(String label, double price) {
        this.label = label;
        this.price = price;
        stock=0;
